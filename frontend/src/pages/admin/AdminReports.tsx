          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {reports.attendanceRate > 80 ? 'Excellent' : reports.attendanceRate > 60 ? 'Good' : 'Needs improvement'}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {reports.noShowRate < 10 ? 'Excellent' : reports.noShowRate < 20 ? 'Good' : 'High'}
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Daily booking patterns over the selected period
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                {reports.branchPerformance && reports.branchPerformance.length > 0 ? (
                  <div className="space-y-4">
                    {reports.branchPerformance.map((branch: any, index: number) => (
                      <div key={index} className="flex items-center justify-between">
                        <div>
                          <p className="font-medium">{branch.name}</p>
                          <p className="text-sm text-gray-500">{branch.bookings} bookings</p>
                        </div>
        ...
        <Card>
          ...
          <CardContent>
            {reports.attendanceDetails && reports.attendanceDetails.length > 0 ? (
              <div className="space-y-4">
                {reports.attendanceDetails.map((record: any, index: number) => (
        ...
        <Card>
          ...
          <CardContent>
            {reports.utilizationDetails && reports.utilizationDetails.length > 0 ? (
              <div className="space-y-4">
                {reports.utilizationDetails.map((slot: any, index: number) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2">
                ...
                {reports.recentAssessments && reports.recentAssessments.length > 0 && (
                  <div>
                    ...
                    <div className="space-y-3">
                      {reports.recentAssessments.map((assessment: any, index: number) => (
